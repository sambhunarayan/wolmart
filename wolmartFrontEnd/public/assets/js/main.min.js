...
$.extend($.easing, {
	...
	(function (t) {
		var e, i, a, n, o, s, r;
		(Dreamdeal.$window = t(window)),
			(Dreamdeal.$body = t(document.body)),
			(Dreamdeal.status = ''),
			(Dreamdeal.isIE = navigator.userAgent.indexOf('Trident') >= 0),
			(Dreamdeal.isEdge = navigator.userAgent.indexOf('Edge') >= 0),
			(Dreamdeal.isMobile =
				/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
					navigator.userAgent,
				)),
			(Dreamdeal.call = function (t, e) {
				setTimeout(t, e);
			}),
			(Dreamdeal.parseOptions = function (t) {
				return 'string' == typeof t
					? JSON.parse(t.replace(/'/g, '"').replace(';', ''))
					: {};
			}),
			(Dreamdeal.parseTemplate = function (t, e) {
				return t.replace(/\{\{(\w+)\}\}/g, function () {
					return e[arguments[1]];
				});
			}),
			(Dreamdeal.byId = function (t) {
				return document.getElementById(t);
			}),
			(Dreamdeal.byTag = function (t, e) {
				return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t);
			}),
			(Dreamdeal.byClass = function (t, e) {
				return e
					? e.getElementsByClassName(t)
					: document.getElementsByClassName(t);
			}),
			(Dreamdeal.setCookie = function (t, e, i) {
				var a = new Date();
				a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3),
					(document.cookie =
						t + '=' + e + ';expires=' + a.toUTCString() + ';path=/');
			}),
			(Dreamdeal.getCookie = function (t) {
				for (
			...
			(Dreamdeal.$ = function (e) {
				return e instanceof jQuery ? e : t(e);
			}),
			(Dreamdeal.isOnScreen = function (t) {
			...
			(Dreamdeal.appear = function (e, i, a) {
				return (
					a &&
			...
			(Dreamdeal.requestTimeout = function (t, e) {
				var i =
			...
			(Dreamdeal.requestInterval = function (t, e, i) {
				var a =
					window.requestAnimationFrame ||
					window.webkitRequestAnimationFrame ||
					window.mozRequestAnimationFrame;
			...
			(Dreamdeal.deleteTimeout = function (t) {
				if (t) {
					var e =
			...
			(Dreamdeal.initCartAction = function (e) {
				Dreamdeal.$body
			...
			(Dreamdeal.initScrollTopButton = function () {
				var e = Dreamdeal.byId('scroll-top');
				...
				Dreamdeal.call(i, 500),
					window.addEventListener('scroll', i, { passive: !0 });
			}),
			(Dreamdeal.stickyDefaultOptions = {
				minWidth: 992,
				maxWidth: 2e4,
				top: !1,
				hide: !1,
			...
			(Dreamdeal.stickyToolboxOptions = {
				minWidth: 0,
				maxWidth: 767,
				top: !1,
				scrollMode: !0,
			}),
			(Dreamdeal.stickyProductOptions = {
				minWidth: 0,
				maxWidth: 2e4,
				scrollMode: !0,
				top: !1,
			...
			(Dreamdeal.windowResized = function (e) {
				return (
					e == Dreamdeal.resizeTimeStamp ||
						(void 0 === window.innerHeight &&
							(window.innerWidth =
								t(window).width() + Dreamdeal.getScrollbarWidth()),
						(Dreamdeal.resizeChanged = Dreamdeal.canvasWidth != window.innerWidth),
						(Dreamdeal.canvasWidth = window.innerWidth),
						(Dreamdeal.resizeTimeStamp = e)),
					Dreamdeal.resizeChanged
				);
			}),
			(Dreamdeal.getScrollbarWidth = function () {
				if (void 0 === Dreamdeal.scrollbarSize) {
					var t = document.createElement('div');
					(t.style.cssText =
						'width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;'),
						document.body.appendChild(t),
						(Dreamdeal.scrollbarSize = t.offsetWidth - t.clientWidth),
						document.body.removeChild(t);
				}
				return Dreamdeal.scrollbarSize;
			}),
			(Dreamdeal.stickyContent = (function () {
				function e(t, e) {
					return this.init(t, e);
				}
				function i() {
					Dreamdeal.$window.trigger('sticky_refresh.Dreamdeal', {
						index: 0,
						offsetTop: 0,
					});
				}
				function a(t) {
					(t && !Dreamdeal.windowResized(t.timeStamp)) ||
						(Dreamdeal.$window.trigger('sticky_refresh_size.Dreamdeal'), i());
				}
				return (
					(e.prototype.init = function (e, i) {
						(this.$el = e),
							(this.options = t.extend(
								...
								Dreamdeal.stickyDefaultOptions,
								i,
								Dreamdeal.parseOptions(e.attr('data-sticky-options')),
							)),
							Dreamdeal.$window
								.on('sticky_refresh.Dreamdeal', this.refresh.bind(this))
								.on('sticky_refresh_size.Dreamdeal', this.refreshSize.bind(this));
					}),
									  ...
									  (this.scrollPos <= i && a.hasClass('fix-bottom'))
											? (a.addClass('fixed'),
											  ...
											  a.hasClass('product-sticky-content') &&
													Dreamdeal.$body.addClass('addtocart-fixed'))
											: (a
													.removeClass('fixed')
													.css('margin-top', '')
													.css('margin-bottom', ''),
											  ...
											  a.hasClass('product-sticky-content') &&
													Dreamdeal.$body.removeClass('addtocart-fixed')),
									  (this.scrollPos = i))
									: (a.addClass('fixed'), this.onFixed && this.onFixed()),
							  a.is('.fixed.fix-top')
									? ((e.offsetTop += a[0].offsetHeight),
									  (Dreamdeal.sticky_top_height = e.offsetTop))
					...
					Dreamdeal.$window.on('Dreamdeal_complete', function () {
						window.addEventListener('scroll', i, { passive: !0 }),
							Dreamdeal.$window.on('resize', a),
							setTimeout(function () {
								a();
							}, 300);
					}),
					function (i, a) {
						Dreamdeal.$(i).each(function () {
							var i = t(this);
			...
			(Dreamdeal.parallax = function (e, i) {
				t.fn.themePluginParallax &&
					Dreamdeal.$(e).each(function () {
						var e = t(this);
						e.themePluginParallax(
							t.extend(
								!0,
								Dreamdeal.parseOptions(e.attr('data-parallax-options')),
								i,
							),
						);
					});
			}),
			(Dreamdeal.skrollrParallax = function () {
				Dreamdeal.isMobile ||
					('undefined' != typeof skrollr &&
						Dreamdeal.$('.skrollable').length &&
						skrollr.init({ forceHeight: !1 }));
			}),
			(Dreamdeal.initFloatingParallax = function () {
				t.fn.parallax &&
					Dreamdeal.$('.floating-item').each(function (e) {
						var i = t(this);
						i.data('parallax') &&
							(i.parallax('disable'),
							...
							i.parallax(Dreamdeal.parseOptions(i.data('options')));
					});
			}),
			(Dreamdeal.isotopeOptions = {
				itemsSelector: '.grid-item',
				layoutMode: 'masonry',
				percentPosition: !0,
				masonry: { columnWidth: '.grid-space' },
			}),
			(Dreamdeal.isotopes = function (e, i) {
					...
					Dreamdeal.$(e).each(function () {
						var e = t(this),
							n = t.extend(
								...
								{},
								a.isotopeOptions,
								Dreamdeal.parseOptions(e.attr('data-grid-options')),
								i || {},
							);
						Dreamdeal.lazyLoad(e),
							e.imagesLoaded(function () {
								n.customInitHeight && e.height(e.height()),
									n.customDelay &&
										Dreamdeal.call(function () {
											e.isotope(n);
			...
			(Dreamdeal.initNavFilter = function (e) {
				t.fn.isotope &&
					Dreamdeal.$(e).on('click', function (e) {
						var i = t(this),
						...
						t(n || '.grid')
							...
							.isotope('on', 'arrangeComplete', function () {
								Dreamdeal.$window.trigger('appear.check');
							}),
			...
			(Dreamdeal.ratingTooltip = function (t) {
				for (
					var e = Dreamdeal.byClass('ratings-full', t || document.body),
						i = e.length,
						a = function () {
							var t =
			...
			(Dreamdeal.setProgressBar = function (e) {
				Dreamdeal.$(e).each(function () {
					var e = t(this),
			...
			(Dreamdeal.alert = function (e) {
				Dreamdeal.$body.on('click', e + ' .btn-close', function (i) {
					i.preventDefault(),
						t(this)
							.closest(e)
							.fadeOut(function () {
			...
			(Dreamdeal.closeTopNotice = function (e) {
				Dreamdeal.$body.on('click', e, function (e) {
					e.preventDefault(), t('.top-banner').slideUp();
				});
			}),
			(Dreamdeal.accordion = function (e) {
				Dreamdeal.$body.on('click', e, function (e) {
					var a = t(this),
			...
			(Dreamdeal.animationOptions = {
				name: 'fadeIn',
				duration: '1.2s',
				delay: '.2s',
			}),
			(Dreamdeal.appearAnimate = function (e) {
				Dreamdeal.$(e).each(function () {
					var e = this;
					Dreamdeal.appear(e, function () {
						if (e.classList.contains('appear-animate')) {
							var i = t.extend(
								{},
								Dreamdeal.animationOptions,
								Dreamdeal.parseOptions(e.getAttribute('data-animation-options')),
							);
							setTimeout(
								function () {
			...
			(Dreamdeal.countDown = function (e) {
				t.fn.countdown &&
					Dreamdeal.$(e).each(function () {
						var e = t(this),
							i = e.data('until'),
			...
			(Dreamdeal.priceSlider = function (e, i) {
			...
			(Dreamdeal.stickySidebarOptions = {
				autoInit: !0,
				minWidth: 991,
			...
			(Dreamdeal.stickySidebar = function (e) {
				if (t.fn.themeSticky) {
					var i = 0;
					function a() {
						Dreamdeal.$(e).trigger('recalc.pin'),
					...
					!t('.sticky-sidebar > .filter-actions').length &&
						...
						setTimeout(a, 300),
						Dreamdeal.$window.on('click', '.tab .nav-link', function () {
							setTimeout(a);
						});
				}
			}),
			(Dreamdeal.zoomImageOptions = {
				responsive: !0,
				borderSize: 0,
				zoomType: 'inner',
				onZoomIn: !0,
			...
			(Dreamdeal.zoomImageObjects = []),
			(Dreamdeal.zoomImage = function (e) {
				t.fn.zoom &&
					e &&
					('string' == typeof e ? t(e) : e).find('img').each(function () {
						var e = t(this);
						(Dreamdeal.zoomImageOptions.target = e.parent()),
							(Dreamdeal.zoomImageOptions.url = e.attr('data-zoom-image')),
							e.zoom(Dreamdeal.zoomImageOptions),
							Dreamdeal.zoomImageObjects.push(e);
					});
			}),
			(Dreamdeal.zoomImageOnResize = function () {
				Dreamdeal.zoomImageObjects.forEach(function (e) {
					e.each(function () {
			...
			(Dreamdeal.lazyLoad = function (t, e) {
				function i() {
				...
				Dreamdeal.$(t)
					.find('.lazy-img')
					.each(function () {
						void 0 !== e && e ? i.call(this) : Dreamdeal.appear(this, i);
					});
			}),
			(Dreamdeal.initPopup = function (e, i) {
				Dreamdeal.$body.hasClass('home') &&
					'true' !== Dreamdeal.getCookie('hideNewsletterPopup') &&
					setTimeout(function () {
						Dreamdeal.popup({
							...
							callbacks: {
								beforeClose: function () {
									t('#hide-newsletter-popup')[0].checked &&
										Dreamdeal.setCookie('hideNewsletterPopup', !0, 7);
								},
							},
						});
					}, 7500),
					Dreamdeal.$body.on('click', '.btn-iframe', function (e) {
						e.preventDefault(),
							Dreamdeal.popup(
								{
									items: {
			...
			(Dreamdeal.initNotificationAlert = function () {
				Dreamdeal.$body.hasClass('has-notification') &&
					setTimeout(function () {
						Dreamdeal.$body.addClass('show-notification');
					}, 5e3);
			}),
			(Dreamdeal.countTo = function (e) {
				t.fn.countTo &&
					Dreamdeal.$(e).each(function () {
						Dreamdeal.appear(this, function () {
							var e = t(this);
							setTimeout(function () {
								e.countTo({
									onComplete: function () {
				...
				}),
				{
					init: function () {
						...
						(i.className = 'minipopup-area'),
							Dreamdeal.byClass('page-wrapper')[0].appendChild(i),
							(e = t(i)),
					...
					open: function (n, l) {
						var c,
							d = this,
							p = t.extend(!0, {}, Dreamdeal.minipopupOption, n);
						(c = t(Dreamdeal.parseTemplate(p.template, p))), (d.space = p.space);
						...
						u.length &&
							u.on('load', function () {
								(i += c[0].offsetHeight + d.space),
									...
									Dreamdeal.$body.on('touchstart', function () {
										d.resume();
									}),
									a.push(c),
			...
			(Dreamdeal.headerToggleSearch = function (t) {
				var e = Dreamdeal.$(t);
				Dreamdeal.$body.on('click', '.hs-toggle .search-toggle', function (t) {
					t.preventDefault();
				}),
					'ontouchstart' in document
						? (e.find('.search-toggle').on('click', function (t) {
						  ...
						  Dreamdeal.$body.on('click', function (t) {
								e.removeClass('show');
						  }),
			...
			(Dreamdeal.scrollTo = function (e, i) {
				var a = void 0 === i ? 0 : i;
	...
	(function (t) {
		var e = function (t) {
				t.preventDefault(), Dreamdeal.$body.addClass('mmenu-active');
			},
			i = function (t) {
				t.preventDefault(), Dreamdeal.$body.removeClass('mmenu-active');
			},
			a = {
				init: function () {
					this.initMenu(),
				...
				initMenu: function () {
					t('.menu li').each(function () {
						...
						Dreamdeal.$window.on('resize', function () {
				...
				initCategoryMenu: function () {
					...
					if (e.length) {
						...
						if (e.hasClass('with-sidebar')) {
							var n = Dreamdeal.byClass('sidebar');
							n.length &&
	...
	(function (t) {
			...
			a = function (t) {
				...
				for (e = 0; e < a; ++e)
					if (!i[e].classList.contains('active')) {
						var n,
							o = Dreamdeal.byClass('appear-animate', i[e]);
					...
					.each(function () {
						var i = t(this),
							a = t.extend(
								...
								{},
								Dreamdeal.animationOptions,
								Dreamdeal.parseOptions(i.data('animation-options')),
							),
							n = a.duration,
							o = a.delay,
							s = a.name;
						setTimeout(function () {
							...
							n = n || '0.75s';
							var a = Dreamdeal.requestTimeout(
								function () {
					...
					a.find('.swiper-slide .slide-animate').each(function () {
						var e = t(this),
							i = t.extend(
								...
								{},
								Dreamdeal.animationOptions,
								Dreamdeal.parseOptions(e.data('animation-options')),
							);
					...
					if (
						...
						if (
							...
							for (var n = 0; n < i.timers.length; n++)
								Dreamdeal.deleteTimeout(i.timers[n]);
							i.timers = [];
						}
						a.find('.swiper-slide-active .slide-animate').each(function () {
							...
							e.css('animation-duration', n),
								...
								e.addClass(s),
								(n = n || '0.75s');
							var r = Dreamdeal.requestTimeout(
								function () {
		...
		(e.defaults = { slidesPerView: 1, speed: 300 }),
				...
				if (!c.data('slider')) {
					...
					f.forEach(function (i) {
						...
						t.extend(
							!0,
							g,
							Dreamdeal.parseOptions(c.attr('data-swiper-options')),
							d,
						),
						i.call(this),
			...
			(Dreamdeal.slider = function (i, a = {}, n = !1) {
				Dreamdeal.$(i).each(function () {
					var i = t(this);
					n
						? new e(i, a)
			...
			(Dreamdeal.slider.pgToggle = function () {
		...
		(e.prototype.init = function (e) {
			...
			return (
				...
				a.$sidebar.length &&
					...
					a.isNavigation &&
						((i = i.bind(this)), Dreamdeal.$window.on('resize', i)),
					Dreamdeal.$window.on('resize', function (t) {
						Dreamdeal.windowResized(t.timeStamp) &&
							Dreamdeal.$body.removeClass(e + '-active');
					}),
					a.$sidebar
					...
					a.$sidebar
						...
						.on('click', function (t) {
							Dreamdeal.$body.removeClass(e + '-active'), t.preventDefault();
						})),
				!1
			);
		}),
			(e.prototype.toggle = function () {
				...
				if (
					...
					e.$sidebar
						...
						Dreamdeal.$body.toggleClass(e.name + '-active').removeClass('closed');
				setTimeout(function () {
					t(window).trigger('appear.check');
				}, 400);
			}),
			(Dreamdeal.sidebar = function (t) {
				return new e().init(t);
			});
	})(jQuery),
	(function (t) {
		var e = {
			init: function () {
				var e;
				Dreamdeal.call(Dreamdeal.ratingTooltip, 500),
					Dreamdeal.call(Dreamdeal.setProgressBar('.progress-bar'), 500),
					this.initVariation(),
					...
					Dreamdeal.$body.on('click', '.select-menu a', function (t) {
						t.preventDefault();
					}),
					Dreamdeal.$body.on('click', '.selected-item i', function (e) {
						t(e.currentTarget)
							.parent()
							.fadeOut(function () {
								var e = t(this),
					...
					Dreamdeal.$body.on('mousedown', function (e) {
						t('.select-menu').removeClass('opened');
					}),
					Dreamdeal.$body.on('click', '.filter-items a', function (e) {
								  ...
								  setTimeout(function () {
										i.removeClass('load-more-overlay loading'),
											Dreamdeal.Minipopup.open({
												...
												actionTemplate:
													'<a href="/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="checkout.html" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
											});
								  }, 500));
						},
					),
					...
					(e = t('.product-popup')).length &&
						Dreamdeal.$body.on('click', '.btn-quickview', function (i) {
							i.preventDefault(),
								Dreamdeal.popup(
									{
					...
					(function () {
						...
						a.length ||
							...
							Dreamdeal.$body.on('click', '.compare-popup-overlay', function () {
								a.removeClass('show');
							});
					})(),
					Dreamdeal.priceSlider('.filter-price-slider');
			},
								...
								a.data('load-state', 'loading'),
									...
									setTimeout(function () {
										a.next().removeClass('loading'),
											...
											Dreamdeal.countDown(i.find('.product-countdown'));
									}, 500);
								var n = parseInt(
		...
		(e.min = 1),
			...
			(e.prototype.startIncrease = function (t) {
				...
				(e.value = e.$value.val()),
					...
					(e.increaseTimer = Dreamdeal.requestTimeout(function () {
						(e.speed = 1),
							(e.increaseTimer = Dreamdeal.requestInterval(function () {
								e.$value.val(
									(e.value = Math.min(
			...
			(e.prototype.startDecrease = function (t) {
				...
				(e.value = e.$value.val()),
					...
					(e.decreaseTimer = Dreamdeal.requestTimeout(function () {
						(e.speed = 1),
							(e.decreaseTimer = Dreamdeal.requestInterval(function () {
								e.$value.val(
									(e.value = Math.max(
										e.value - Math.floor((e.speed *= 1.05)),
										e.min,
			...
			(e.prototype.stop = function (t) {
				Dreamdeal.deleteTimeout(this.increaseTimer),
					Dreamdeal.deleteTimeout(this.decreaseTimer);
			}),
			(Dreamdeal.initQtyInput = function (i) {
				Dreamdeal.$(i).each(function () {
					var i = t(this);
		...
		(e.defaults = {
			...
			(e.prototype.init = function (i, a) {
				...
				n.isOpen
					...
					Dreamdeal.$body.on('mousedown', '.mfp-wrap', o),
					'ontouchstart' in document &&
						document.addEventListener('touchstart', o, { passive: !0 });
			}),
			(Dreamdeal.popup = function (t, i) {
				return new e(t, i);
			});
	})(jQuery),
	(function (t) {
		function e(e) {
			...
			if (
				...
				if ('undefined' != typeof PhotoSwipe) {
					var c = t('.pswp')[0];
					if ('rtl' == Dreamdeal.$body.attr('dir'))
		...
		Dreamdeal.initProductSinglePage = function () {
			t('.product-gallery').each(function () {
				var e = t(this),
					i = e.find('.product-image');
				i.length &&
					0 == e.find('.swiper-container').length &&
					i.zoom(Dreamdeal.zoomImageOptions);
			}),
				(function (e) {
					var i = t(e),
	...
	(function (t) {
		Dreamdeal.initCodePopup = function () {
			t('.box-btn.showcode span').each(function () {
				...
				Dreamdeal.$body.on('click', '.box-btn.showcode', function () {
					var e = t(this);
					e.hasClass('enabled')
				...
				Dreamdeal.$body.on('click', '.show-code', function (e) {
					e.stopPropagation();
					var i = t(this).parent();
					if (i.hasClass('show-code-added')) {
						...
						i[0].removeChild(a),
							...
							Dreamdeal.$body.on('click', '.code-copy a', function (e) {
								e.preventDefault(),
	...
	(function (t) {
		...
		(e.defaultOptions = {
			...
			(e.prototype.init = function (a, n) {
				...
				(o.element = a),
					(o.settings = t.extend(
						...
						!0,
						e.defaultOptions,
						Dreamdeal.parseOptions(a.attr('data-calendar-options')),
						n,
					)),
					(o.today = new Date()),
					(i = i.bind(this));
			...
			(Dreamdeal.calendar = function (i, a) {
				Dreamdeal.$(i).each(function () {
					var i = t(this);
					Dreamdeal.call(function () {
						new e(i, a);
			...
			(Dreamdeal.initVendor = function (e) {
				var i = t(e),
			...
			(Dreamdeal.slideContent = function (e) {
				var i = t(e),
					a = i.next();
			...
			(Dreamdeal.initLoginVendor = function (e) {
				var i = t(e),
	...
	jQuery,
	(Dreamdeal.initLayout = function () {
		Dreamdeal.isotopes('.grid:not(.grid-float)'),
			Dreamdeal.stickySidebar('.sticky-sidebar');
	}),
	(Dreamdeal.init = function () {
		Dreamdeal.appearAnimate('.appear-animate'),
			Dreamdeal.setTab('.nav-tabs'),
			Dreamdeal.stickyContent('.sticky-header', { scrollMode: !1 }),
			Dreamdeal.stickyContent('.sticky-footer', {
				minWidth: 0,
				maxWidth: 767,
				top: 150,
				hide: !0,
			...
			Dreamdeal.stickyContent('.sticky-toolbox', Dreamdeal.stickyToolboxOptions),
			Dreamdeal.stickyContent(
				'.product-sticky-content',
				Dreamdeal.stickyProductOptions,
			),
			Dreamdeal.parallax('.parallax'),
			Dreamdeal.skrollrParallax(),
			Dreamdeal.initFloatingParallax(),
			Dreamdeal.menu.init(),
			Dreamdeal.initScrollTopButton(),
			Dreamdeal.shop.init(),
			Dreamdeal.alert('.alert'),
			Dreamdeal.closeTopNotice('.banner-close'),
			Dreamdeal.accordion('.card-header > a'),
			Dreamdeal.sidebar('sidebar'),
			Dreamdeal.sidebar('right-sidebar'),
			Dreamdeal.initProductSinglePage(),
			Dreamdeal.initQtyInput('.quantity'),
			Dreamdeal.initNavFilter('.nav-filters .nav-filter'),
			Dreamdeal.calendar('.calendar-container'),
			Dreamdeal.countDown('.product-countdown, .countdown'),
			Dreamdeal.initPopup(),
			Dreamdeal.initNotificationAlert(),
			Dreamdeal.countTo('.count-to'),
			Dreamdeal.initCartAction('.cart-offcanvas .cart-toggle'),
			Dreamdeal.Minipopup.init(),
			Dreamdeal.headerToggleSearch('.hs-toggle'),
			Dreamdeal.initVendor('.store'),
			Dreamdeal.slideContent('.login-toggle'),
			Dreamdeal.slideContent('.coupon-toggle'),
			Dreamdeal.slideContent('.checkbox-toggle'),
			Dreamdeal.initLoginVendor('.user-checkbox'),
			Dreamdeal.initCodePopup(),
			Dreamdeal.slider('.swiper-container'),
			Dreamdeal.call(Dreamdeal.slider.pgToggle),
			Dreamdeal.$window.on('resize', function () {
				Dreamdeal.call(Dreamdeal.slider.pgToggle);
			});
	}),
	...
	(window.onload = function () {
		(Dreamdeal.canvasWidth = window.innerWidth),
			(Dreamdeal.resizeTimeStamp = 0),
			(Dreamdeal.resizeChanged = !1),
			(Dreamdeal.status = 'loaded'),
			document.body.classList.add('loaded'),
			Dreamdeal.call(Dreamdeal.initLayout),
			Dreamdeal.call(Dreamdeal.init),
			(Dreamdeal.status = 'complete'),
			Dreamdeal.$window.trigger('Dreamdeal_complete');
	});
