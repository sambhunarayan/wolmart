						...
						<div className="intro-wrapper col-lg-9 mt-4 mb-4">
							...
							>
								<div
									...
									id="swiper-wrapper-97ddf3ce10c5c42e"
									aria-live="polite"
									style={{
								...
								>
									...
									>
										<div className="banner-content y-50">
											<h3
												className="banner-subtitle text-uppercase text-primary font-secondary font-weight-bold slide-animate fadeInDownShorter show-content"
												data-animation-options='{"name": "fadeInDownShorter", "duration": ".5s", "delay": ".2s"}'
											>
												From Online Store
											</h3>
											<h2
												className="banner-title font-secondary text-dark slide-animate fadeInLeftShorter show-content"
											...
											<hr
												className="divider slide-animate fadeInRightShorter show-content"
												data-animation-options='{"name": "fadeInRightShorter", "duration": ".5s", "delay": ".5s"}'
											/>
											<h5
												className="text-dark text-uppercase font-secondary font-weight-bold mb-2 slide-animate fadeInRightShorter show-content"
												data-animation-options='{"name": "fadeInRightShorter", "duration": ".5s", "delay": ".4s"}'
											>
												For - Women
											</h5>
											<h5
												className="product-identifier font-weight-normal text-dark text-uppercase slide-animate fadeInUpShorter show-content"
												data-animation-options='{"name": "fadeInUpShorter", "duration": ".5s", "delay": ".6s"}'
											>
												Product Identifier:{' '}
