		...
		<>
			...
			>
				<div
					...
					id="swiper-wrapper-f184426eeb2fc39a"
					aria-live="polite"
						...
						<div className="product-widget-wrap">
							<div className="product product-widget">
								<figure className="product-media">
									<a href="product-default.html">
										<img
											src="assets/img/products/2-2-1.jpg"
											alt="Product"
											width="100"
											height="106"
										/>
										<img
											src="assets/img/products/2-2-2.jpg"
											alt="Product"
											width="100"
											height="106"
										/>
						...
						<div className="product-widget-wrap">
							<div className="product product-widget">
								<figure className="product-media">
									<a href="product-default.html">
										<img
											src="assets/img/products/2-6-1.jpg"
											alt="Product"
											width="100"
											height="106"
										/>
										<img
											src="assets/img/products/2-6-2.jpg"
											alt="Product"
											width="100"
											height="106"
										/>
...
export default swiperContainer3;
