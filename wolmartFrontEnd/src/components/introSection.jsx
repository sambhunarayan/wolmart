			...
			<div className="intro-section mb-2">
				<div className="row">
					<div className="intro-wrapper col-lg-9 mt-4 mb-4">
						<div
							className="swiper-container swiper-theme pg-inner pg-white animation-slider swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
							data-swiper-options="{
                                                'spaceBetween': 0,
                                                'slidesPerView': 1
                                            }"
						>
							<div
								...
								id="swiper-wrapper-439ea6a17472556b"
								aria-live="polite"
							>
								<div
									className="swiper-slide banner banner-fixed intro-slide intro-slide1 br-sm swiper-slide-active"
									style='background-image: url("assets/img/intro-3.jpg"); background-color: rgb(63, 62, 58); width: 865px;'
									role="group"
									aria-label="1 / 3"
								>
									<div className="banner-content y-50 text-right">
										<h3
											className="banner-subtitle text-uppercase font-secondary font-weight-bolder slide-animate fadeInLeftShorter show-content"
										...
										<h2
											className="banner-title font-secondary text-capitalize text-white slide-animate fadeInRightShorter show-content"
										...
										<h4
											className="banner-price-info font-weight-normal text-white ls-25 slide-animate fadeInRightShorter show-content"
											data-animation-options="{'name': 'fadeInRightShorter', 'duration': '.5s', 'delay': '.4s'}"
											style=""
										>
											Discount
										...
										<a
											href="index.html"
											className="btn btn-outline btn-white btn-rounded btn-icon-right slide-animate fadeInUpShorter show-content"
								...
								<div
									className="swiper-slide banner banner-fixed intro-slide intro-slide2 br-sm swiper-slide-next"
									style='background-image: url("assets/img/intro-2.jpg"); background-color: rgb(226, 226, 224); width: 865px;'
									role="group"
									aria-label="2 / 3"
								>
								...
								<div
									...
									style='background-image: url("assets/img/intro-1.jpg"); background-color: rgb(234, 234, 234); width: 865px;'
									role="group"
									aria-label="3 / 3"
								>
									<div className="banner-content y-50">
