			...
			<div className="main-content">
				<div className="product product-single row">
									...
									>
										...
										>
											...
											<img
												role="presentation"
												alt="Electronics Black Wrist Watch"
												src="https://dreamdealecom-html.netlify.app/assets/img/products/1-800x900.jpg"
												className="zoomImg"
												style={{
													position: 'absolute',
													top: '-252.791px',
									...
									>
										...
										>
											...
											<img
												role="presentation"
												alt="Electronics Black Wrist Watch"
												src="https://dreamdealecom-html.netlify.app/assets/img/products/3-800x900.jpg"
												className="zoomImg"
												style={{
													position: 'absolute',
													top: '0px',
					...
					<div className="col-md-6 mb-6 mb-md-8">
						...
						>
							<h1 className="product-title">3D Television</h1>
							...
							<div className="product-price">
								<ins className="new-price">
									<span className="rupee">₹</span>210.00 -{' '}
									<span className="rupee">₹</span>230.00
								</ins>
							</div>
